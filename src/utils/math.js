/**
  * This module provides math functions suited for calculating optimal amount of multi-path arbitrage strategy on Uniswap pools.
  ...
  * @dev This only works if the fee is the same across all pools - otherwise it becomes inaccurate
*/

const { BigNumber } = require('ethers')
const BN = require('bignumber.js')

let d1000 = BigNumber.from("1000")  // TODO: move to config/env
let d997 = BigNumber.from("997")  // TODO: move to config/env
