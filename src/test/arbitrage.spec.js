...
describe('arbitrage', async () => {
    ...
    it('Detects obvious arbitrage', async () => {
        ...
        arbMngr.reserveMngr.updateReserves(updatePool, data)
        const arbs = await arbMngr.arbsSearch(arbMngr.instrMngr.paths)
